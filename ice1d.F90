MODULE ice1D
   ...
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:) ::   h_s_1d_old    !:    Used if ln_snwext = T
   ...
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:) ::   e_s_1d_old !:    Used if ln_snwext = T
...
CONTAINS
   ...
   FUNCTION ice1D_alloc()
      ...
      ALLOCATE( t_su_1d (jpij) , t_si_1d (jpij) , a_i_1d    (jpij) , a_ib_1d (jpij) ,                   &
         &      h_i_1d  (jpij) , h_ib_1d (jpij) , h_s_1d    (jpij) , h_s_1d_old(jpij) ,                 &    
