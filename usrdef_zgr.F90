...
CONTAINS             
   ...
   SUBROUTINE usr_def_zgr( ld_zco  , ld_zps  , ld_sco  , ld_isfcav,    &   ! type of vertical coordinate
      ...
      !ENDIF
      IF(lwp) THEN            ! Parameter print
         WRITE(numout,*) '     zgr   : custom z-coordinates '
      ...
      !END DO
      pdept_1d = (/4.99994, 15.00029, 25.00176, 35.00541, 45.01332, 55.02950, &
        65.06181, 75.12551, 85.25037, 95.49428, 105.96992, 116.89624, &
        128.69790, 142.19525, 158.96061, 181.96278, 216.64792, 272.47672, &
        364.30304, 511.53477, 732.20086, 980.07820, 1199.20443 /)
      pdepw_1d = (/0.00000, 10.00002, 20.00083, 30.00322, 40.00864, 50.02000, &
        60.04292, 70.08833, 80.17757, 90.35213, 100.69280, 111.35667, &
        122.64877, 135.15975, 150.02680, 169.41597, 197.36778, 241.12593, &
        312.74467, 429.72336, 611.88909, 872.87378, 1092.00000/)
      !
